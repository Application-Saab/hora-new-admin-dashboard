...
const CreateOrderForm = ({
  ...
  useEffect(() => {
    ...
    console.log("calculateFinalTotal:", finalTotal);
    console.log("calculateAdvancePayment:", advanceTotal);

    setTotalAmount(finalTotal);
    setAdvanceAmount(advanceTotal);
  }, [calculateFinalTotal, calculateAdvancePayment]);

  useEffect(() => {
    const finalTotal = calculateFinalTotal();
    const advanceTotal = calculateAdvancePayment();
    const remainingAmount = finalTotal - advanceTotal;

    console.log("useEffect 2:");
    console.log("Final Total:", finalTotal);
    console.log("Advance Total:", advanceTotal);
    console.log("Remaining Amount:", remainingAmount);
    console.log("Delivery Charges:", deliveryCharges);
    // If you want to debug discount-related logic as well:
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("selectedMealListselectedMealList", selectedMealList);
  ...
  const copyOrderSummary = () => {
    ...
    orderData += `*Time of Delivery:* ${
      timeSlot ? timeSlot.value : "To be shared by customer"
    }\n`;
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        <>
          <label htmlFor="customerNumber" style={style.label}>
            Customer Number*
          </label>
          <input
            type="text"
            ...
            <div className="orderDeatils">
              ...
              >
                <div style={style.dateTimeField}>
                  <label htmlFor="date" style={style.label}>
                    Date *
                  </label>
                  <input
                    type="date"
                ...
                <div style={style.dateTimeField}>
                  <label htmlFor="timeSlot" style={style.label}>
                    Time Slot*
                  </label>
                  <Select
              ...
              <label htmlFor="totalamount" style={style.label}>
                Total Amount*
              </label>
              <input
                type="text"
              ...
              <label htmlFor="balanceamount" style={style.label}>
                Balance Amount
              </label>
              <input
                type="text"
              ...
              <div style={{ margin: "10px 0", width: "100%" }}>
                <label htmlFor="city" style={style.label}>
                  City *
                </label>
                <select
                  id="city"
