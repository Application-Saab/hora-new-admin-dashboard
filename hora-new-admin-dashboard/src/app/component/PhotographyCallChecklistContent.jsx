    ...
    return (
        <>
            <div className="checklist-body">
                ...
                {/* Iski jagah ye laga do */}
                <div className="checklist-block">
                    <label className="checkbox-label">
                        <input
                            type="checkbox"
                            checked={callChecklist.poseReferenceChecked || false}
                            onChange={() =>
                                setCallChecklist((prev) => ({
                                    ...prev,
                                    poseReferenceChecked:
                                        !prev.poseReferenceChecked,
                                }))
                            }
                        />
                ...
                {callChecklist.photographyLocation?.Other && (
                    <textarea
                        className="photography-checklist-textarea"
