...
const CheckVendorOrders = () => {
  ...
  const handleCheckSupplier = async (e) => {
    ...
    try {
      ...
      console.log(supplier.name, "supplioer");
  ...
  const ButtonToActive_InActive = async (result, status) => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/api/admin/update_user_status`,
        {
          method: "POST",
          headers: {
        ...
        <div className="leftContent">
          ...
          {result && (
            <div
              style={{
                textAlign: "center",
                backgroundColor: result.includes("present")
                  ? "#f8d7da"
                  : "#d4edda",
            ...
            >
              ...
              <p className="supplierName"> Supplier Name : {supplierName}</p>
              ...
              <div>
                ...
                <div className="orderSummarTableContainer">
                  ...
                  <table className="orderSummaryTable">
                    ...
                    <tbody>
                      {Object.entries(ratingSummary).map(
                        ([key, value], index) => (
                          <tr
                            key={index}
                            style={{
