...
//     gasRequired: '',
//     description: '',
//     dishDescription: '', // New field for "Description of dish"
//     servingDish: '' // New field for "Serving Dish"
//   });
...
//       { _id: 'no', name: 'No' }
//     ],
//     servingDishOptions: [] // New options for "Serving Dish"
//   });
...
//           ...prevData,
//           dishImage: data.data.imageUrl // Assuming the response contains the image URL
//         }));
...
//       // Close the dropdown after adding an ingredient
...
//                   type="text"
//                   placeholder="Search..."
//                   onChange={(e) => console.log(`Search ${name}: ${e.target.value}`)}
//                 />
//               </div>
//               <div>
//                 {options.map(option => (
//                   <div key={option._id} className={styles["dropdown-option"]}>
//                     <input
//                       type="radio"
//                       id={`${name}-${option._id}`}
//                       checked={value === option._id}
//                       onChange={() => handleDropdownSelect(name, option._id)}
//                     />
...
//           {formData.dishType === 'serving-dish' && renderDropdown("servingDish", "Serving Dish", options.servingDishOptions, true)}
//           {renderDropdown("category", "Category", options.categoryOptions)}
//           {renderDropdown("cuisineType", "Cuisine Type", options.cuisineTypeOptions, true)}
//           {renderDropdown("mealType", "Meal Type", options.mealTypeOptions, true)}
...
//                         <div key={ingredient._id} className={styles["dropdown-option"]}>
//                           <input
//                             type="radio"
//                             id={`ingredient-${ingredient._id}`}
//                             checked={selectedIngredient === ingredient._id}
//                             onChange={() => setSelectedIngredient(ingredient._id)}
//                           />
...
//                   {dropdownOpen.ingredientUnit && (
//                     <div className={styles["dropdown-menu"]}>
//                       <div>
//                         {options.quantityUnitOptions.map(unit => (
//                           <div key={unit._id} className={styles["dropdown-option"]}>
//                             <input
//                               type="radio"
//                               id={`unit-${unit._id}`}
//                               checked={ingredientUnit === unit._id}
//                               onChange={() => setIngredientUnit(unit._id)}
//                             />
...
//           {renderDropdown("generalAppliance", "General Appliance", options.generalApplianceOptions)}
//           {renderDropdown("specialAppliance", "Special Appliance", options.specialApplianceOptions)}
...
//             <button type="submit" className={`${styles["btn"]} ${styles["btn-success"]}`}>Submit</button>
//           </div>
//         </div>
//       </form>
//     </div>
