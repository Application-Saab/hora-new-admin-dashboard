...
function AddFoodOrder() {
  ...
  const calculateFinalTotal = () => {
    ...
    if (selectedDeliveryOption === "food-delivery") {
      {
        finalTotal =
          parseFloat(discountedPrice) > 4000
  ...
  const RenderDishQuantity = ({ item }) => {
    ...
    if (
      ...
      (item.mealId[0] == "63f1b6b7ed240f7a09f7e2de" ||
        item.mealId[0] == "63f1b39a4082ee76673a0a9f" ||
        item.mealId[0] == "63edc4757e1b370928b149b3")
    ) {
      if (itemCount == 4) {
          ...
          {foodListDownDropOpen && (
            <>
              {loading ? (
                ...
                >
                  <ul
                    className="popup-dishes-list"
                    style={style.popupDishesList}
                  >
              ...
              <div>
                <div
                  style={{
                    ...
                    justifyContent: "space-between",
                    alignItems: "center",
                    backgroundColor: includeDisposable ? "#efefef" : "#fff",
                    padding: "4px",
                    margin: "0px 0 17px 0",
                    borderBottom: "1px solid rgb(215, 215, 215)",
                ...
                >
                  ...
                  >
                    <button
                      onClick={() => setIncludeDisposable(!includeDisposable)}
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderWidth: 1,
                          borderStyle: "solid",
                          borderColor: includeTables ? "#008631" : "#008631",
                          borderRadius: 3,
                          alignItems: "center",
                          justifyContent: "center",
                          marginRight: 4,
